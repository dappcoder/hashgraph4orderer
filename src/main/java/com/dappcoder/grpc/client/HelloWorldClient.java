...
/**
 * A simple client that requests a greeting from the {@link com.dappcoder.grpc.server.GrpcServer}.
 */
public class HelloWorldClient {
  ...
  public static void main(String[] args) throws Exception {
    HelloWorldClient client = new HelloWorldClient("localhost", 51207);
    try {
